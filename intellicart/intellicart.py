from sensorhat import Pin, ADC, PWM, Servo, fileDB
from sensorhat import Grayscale_Module, Ultrasonic, utils
import time
import os
...
class Intellicart(object):
    ...
    def __init__(self, 
        ...
        self.dir_cali_val = float(self.config_flie.get("intellicart_dir_servo", default_value=0))
        self.cam_pan_cali_val = float(self.config_flie.get("intellicart_cam_pan_servo", default_value=0))
        self.cam_tilt_cali_val = float(self.config_flie.get("intellicart_cam_tilt_servo", default_value=0))
        ...
        self.cali_dir_value = self.config_flie.get("intellicart_dir_motor", default_value="[1, 1]")
    ...
    def motor_direction_calibrate(self, motor, value):
        ...
        if value == 1:
            ...
            self.cali_dir_value[motor] = -1
        self.config_flie.set("intellicart_dir_motor", self.cali_dir_value)
    def dir_servo_calibrate(self, value):
        self.dir_cali_val = value
        self.config_flie.set("intellicart_dir_servo", "%s"%value)
    ...
    def cam_pan_servo_calibrate(self, value):
        ...
        self.config_flie.set("intellicart_cam_pan_servo", "%s"%value)
        self.cam_pan.angle(value)
    def cam_tilt_servo_calibrate(self, value):
        self.cam_tilt_cali_val = value
        self.config_flie.set("intellicart_cam_tilt_servo", "%s"%value)
